...
const TrenerDiagnosta = () => {
  return (
    <>
      <AnimatedSectionContainer className="max-w-[1280px] mx-auto pt-24 px-4">
        <motion.div variants={animatedSectionChildVariants}>
          <Badge className="bg-green-500 text-background" variant={"default"}>
            Website
          </Badge>
          <h1 className="text-4xl font-bold tracking-tight lg:text-6xl mt-2 mb-4">Trener diagnosta.</h1>
        </motion.div>
      ...
      <AnimatedSectionContainer className="max-w-[1280px] mx-auto py-8 px-4">
        <motion.p variants={animatedSectionChildVariants} className="text-md text-muted-foreground mb-4">
        ...
        <motion.p variants={animatedSectionChildVariants} className="text-md text-muted-foreground mb-8">
          Role: Frontend Developer
        </motion.p>
      </AnimatedSectionContainer>
      <AnimatedSectionContainer once className="py-8">
        <motion.div className="relative" variants={animatedSectionChildVariants}>
          <Marquee className="!absolute top-[50%] translate-y-[-50%]" autoFill>
            <h1 className="px-1 text-4xl font-bold tracking-tight lg:text-6xl">TRENER DIAGNOSTA</h1>
          </Marquee>
          <div className="relative max-w-[1280px] mx-auto z-[1]">
