...
const TrenerDiagnosta = () => {
  const getImage = (src: StaticImageData, alt: string, className: string) => {
    return (
      <motion.div className={`${className} bg-default-200 rounded-xl p-2 overflow-hidden min-w-[400px]`} variants={childVariants}>
  ...
  return (
    <>
      ...
      <AnimatedSectionContainer className="mt-8 w-full bg-[rgb(210,237,237)] py-8 overflow-hidden md:h-[75vh] h-[50vh] min-h-[500px] max-h-[800px]">
        <ParallaxItem reverse className="max-w-[2048px] mx-auto w-full flex flex-col gap-8">
