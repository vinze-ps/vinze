  ...
  return (
    <>
      ...
      <div className="max-w-[1024px] mx-auto flex gap-8 items-center z-[1] relative min-h-[100vh]">
        <div className="w-full flex flex-col max-w-[612px]">
          ...
          <motion.p variants={childVariants} className="text-md text-muted-foreground">
            ...
            <motion.a
              variants={childVariants}
              href="https://www.p88.pl"
              target="_blank"
              className="text-[hsl(var(--light-blue))]"
            >
              {" "}
              Personal&apos;88
            </motion.a>
      ...
      <Marquee className="mb-16" autoFill gradient gradientColor="#fff">
        <div className="px-16">
          <HTML5Icon className="[&>path]:fill-[black]" />
        </div>
        <div className="px-16">
          <FigmaIcon className="[&>path]:fill-[black]" />
        </div>
        <div className="px-16">
          <ReduxIcon className="[&>path]:fill-[black]" />
        </div>
        <div className="px-16">
          <WebIcon />
        </div>
      ...
      <Marquee className="mb-32" autoFill gradient gradientColor="#fff" direction="right">
        <div className="px-16">
          <NextJSIcon className="[&>path]:fill-[black]" />
        </div>
        <div className="px-16">
          <ReactIcon className="[&>path]:fill-[black]" />
        </div>
        <div className="px-16">
          <JSIcon className="[&>path]:fill-[black]" />
        </div>
        <div className="px-16">
          <NodeJSIcon className="[&>path]:fill-[black]" />
        </div>
      </Marquee>
    </>
  );
