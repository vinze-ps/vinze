...
const CardSection = () => {
  return (
    <AnimatedSectionContainer className="my-16 md:my-32 w-full max-w-[1280px] mx-auto flex gap-8 z-[1] relative flex-col md:flex-row px-4">
      ...
      <div className="bg-default-50 w-full h-[600px] rounded-lg p-8 shadow-xl overflow-hidden relative">
        ...
        <motion.h1 variants={animatedSectionChildVariants} className="text-4xl font-bold tracking-tight lg:text-6xl mb-4 text-primary">
          Design.
        </motion.h1>
